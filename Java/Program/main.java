...
public class main {
    public static void main(String[] args) {
        ...
        for(i = 0; i < n; i++) {
            ...
            pakaian.setIdProduct(idProduct);
            pakaian.setName(name);
            pakaian.setBrand(brand);
            pakaian.setPrice(price);
            pakaian.setSize(size);
            pakaian.setMaterial(material);
            pakaian.setGender(gender);
            pakaian.setColor(color);
            pakaian.setSleeveType(sleeve_type);
       
            // Menambahkan objek Shirt ke dalam list
            listShirt.add(pakaian);
        }
